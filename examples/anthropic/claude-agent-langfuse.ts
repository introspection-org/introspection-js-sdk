/**
 * Claude Agent SDK + Langfuse + Introspection Example
 *
 ...
 *
 * Requires: LANGFUSE_PUBLIC_KEY, LANGFUSE_SECRET_KEY, INTROSPECTION_TOKEN, ANTHROPIC_API_KEY
 *
 * Run with: pnpm claude-agent-langfuse
 */
...
console.log("  - Langfuse (via CompositeSpanExporter)");
